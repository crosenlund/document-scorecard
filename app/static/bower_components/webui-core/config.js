System.config({
  ...
  map: {
    ...
    "clean-css": "npm:clean-css@3.3.10",
    ...
    "moment-timezone": "npm:moment-timezone@0.5.0",
    "phantomjs-polyfill": "npm:phantomjs-polyfill@0.0.2",
